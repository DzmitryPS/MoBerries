...
const StyledCircleButton = styled.button`
  ...
  background-color: ${({ isActive }) =>
    isActive === 0 ? `${theme.color.light}` : `${theme.color.secondary}`};
...
const StyledCircleButtonTwo = styled.button`
  ...
  height: 16px;
  background-color: ${({ isActive }) =>
    isActive === 1 ? `${theme.color.light}` : `${theme.color.secondary}`};
  transition: all 500ms;
...
const StyledCircleButtonThree = styled.button`
  ...
  height: 16px;
  background-color: ${({ isActive }) =>
    isActive === 2 ? `${theme.color.light}` : `${theme.color.secondary}`};
  transition: all 500ms;
